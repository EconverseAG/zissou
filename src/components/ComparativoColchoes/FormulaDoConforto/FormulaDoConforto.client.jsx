      ...
      <div className={styles.FormulaDoConfortoTop}>
        ...
        <div className={styles.FormulaDoConfortoTopContent}>
          ...
          <span className={styles.FormulaDoConfortoTopContentSubtitle}>
            Selecionamos as variações de látex mais sofisticadas do mundo, com
            características especiais mais avançadas
          </span>
          <ul className={styles.FormulaDoConfortoTopContentList}>
            <li>
              <strong className={styles.FormulaDoConfortoTopContentListBold}>
                • Acefom HR:
              </strong>{' '}
            ...
            <li>
              ...
              microclima equilibrado, controle de umidade e mais elasticidade
              para facilitar os movimentos durante o sono
            </li>
          </ul>
        </div>
      </div>
      <div className={styles.FormulaDoConfortoBottom}>
        ...
        <div className={styles.FormulaDoConfortoBottomContent}>
          ...
          <span className={styles.FormulaDoConfortoBottomContentText}>
            O viscoelástico de memória responsiva proporciona aconchego e aquela
            sensação gostosa de abraço, aliviando pontos de pressão, mitigando a
            transmissão de ondas de movimento e reunindo propriedades
            hipoalergênicas e antimicrobianas
          </span>
        </div>
      </div>
    </div>
