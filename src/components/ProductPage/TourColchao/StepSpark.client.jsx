...
function StepSparkContent({content, setModal}) {
  ...
  return (
    <>
      <div
        className={styles.TourSparkButtons}
        ref={openModal ? wrapperRef : null}
      >
        <button className={styles.TourSparkButton} onClick={handleOpenModal}>
          <strong
            dangerouslySetInnerHTML={{__html: content.title}}
            className={styles.TourSparkButtonTitle}
          />
          <span className={styles.TourSparkButtonCTA} />
        </button>
      </div>
    </>
  );
...
export default memo(StepSparkContent, (prevProps, nextProps) => {
